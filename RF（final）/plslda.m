function LDA=plslda(X,y,A,method,prior)
...
%        or 'center' 
%        or 'pareto';
%+++ prior: prior probability of positive class; ranging in (0,1). default to 0 for auto-derive prior.
...
C=ldapinv(T,y,prior);                      %+++ Discriminant analysis
