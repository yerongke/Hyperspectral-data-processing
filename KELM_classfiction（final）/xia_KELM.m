...
%% 训练集训练
[TrainingTime, TrainingAccuracy, ELM_Kernel_Model]=elm_kernel_train(P_train,T_train,7,1,100, 'RBF_kernel',1);%AddLabel是分类总数

%% 预测结果
[TestingTime, T_sim_1] = elm_kernel_predict(a1_P_test, P_train, ELM_Kernel_Model);
[TestingTime, T_sim_2] = elm_kernel_predict(a2_P_test, P_train, ELM_Kernel_Model);
[TestingTime, T_sim_3] = elm_kernel_predict(a3_P_test, P_train, ELM_Kernel_Model);
[TestingTime, T_sim_4] = elm_kernel_predict(a4_P_test, P_train, ELM_Kernel_Model);
[TestingTime, T_sim_5] = elm_kernel_predict(a5_P_test, P_train, ELM_Kernel_Model);
[TestingTime, T_sim_6] = elm_kernel_predict(a6_P_test, P_train, ELM_Kernel_Model);
...
string = {'真实值预测值结果对比(KELM)';['(正确率Accuracy = ' num2str(Accuracy_8) '%)' ]};
title(string)
